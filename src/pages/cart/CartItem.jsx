...
export const CartItem = (props) => {
    const { cartItems, addToCart, removeFromCart, getTotalCartAmount, deleteFromCart, updateCartItemCount, likeItems, addToLikes } = useContext(ShopContext)
  ...
  return (
    ...
    <tr key={props.data.id}>
        ...
        <td className="align-middle">
            <button className="btn btn-sm btn-danger" onClick={() => deleteFromCart(props.data.id)}><i className="fa fa-times"></i></button>
        </td>
    </tr>
    </>
  )
